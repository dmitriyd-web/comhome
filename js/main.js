document.addEventListener('DOMContentLoaded', function(){
	...
	if ( window.innerWidth >= 1200 ) {
		...
		let showFromTop = gsap.utils.toArray('.advantages h2')
		...
		let showFromLeft = gsap.utils.toArray('.advantages-single__1, .advantages-single__2')
		...
		let showFromRight = gsap.utils.toArray('.advantages-single__3, .advantages-single__4')
